...
namespace MusicStore
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                //Unless I am missing something, this routes effectivly override the default route
                //entirely because they have the same number of required segments "controller/action"
